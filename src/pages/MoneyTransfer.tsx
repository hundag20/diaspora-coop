        ...
        <Grid item className="grid-item" xs={12} sm={6} md={4}>
          <Card className="agent-card">
            <CardMedia
              ...
              sx={{
                objectFit:
                  i > transferAgents.length - 3 ? "contain" : "initial",
              }}
            ></CardMedia>
...
const Resources = () => (
  <div className="resources-container">
    <div className="title">
      <h2>
        Some Useful <span>Diaspora</span> Resources
      </h2>
    </div>
...
export function MoneyTransfer(props: IMoneyTransferProps) {
  ...
  return (
    <div>
      <TopBanner
        containerClass="mt hd-container"
        overlayClass="mt hd-background-overlay"
        contentClass="mt hd-content"
      ...
      <div className="title">
        <h2>
          <strong>International Remittance</strong>
        </h2>
      </div>

...
export function AccountOpeningWizardForm(props: IAccountOpeningFormProps) {
  ...
  const handleStep1Save = () => {
    setLoader(true);
    axios
      .post(`${apiUrl}api/v1/accounts/update/${formData.id}`, {
        fullName: formData.fullName,
        surname: formData.surname,
        motherName: formData.motherName,
        sex: formData.sex,
  ...
  const handleSubmit = () => {
    ...
    if (validateStep(activeStep)) {
      ...
      setLoader(true);
      const requestInfo = axios.post(`${apiUrl}api/v1/accounts/update/${formData.id}`, {
        fullName: formData.fullName,
        surname: formData.surname,
        motherName: formData.motherName,
        email: formData.email,
      ...
      //   `${apiUrl}api/v1/accounts/update/${formData.id}/upload-files`,
      //   formdata
      // );
